# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2019-02-27 19:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rating', models.CharField(choices=[(apps.roundtable.models.Ratings(2), 2), (apps.roundtable.models.Ratings(1), 1), (apps.roundtable.models.Ratings(0), 0), (apps.roundtable.models.Ratings(-1), -1), (apps.roundtable.models.Ratings(-5), -5)], max_length=5)),
            ],
        ),
        migrations.CreateModel(
            name='Restaurant',
